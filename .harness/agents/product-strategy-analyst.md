...
Antes de analizar o modificar intención de producto, carga y aplica `.harness/skills/product-owner-prd/SKILL.md`. Selecciona únicamente el workflow y las referencias que correspondan a la operación `CREATE`, `UPDATE`, `REVIEW` o `RECONCILE`.
...
1. Lee `AGENTS.md`, `.harness/manifest.yaml`, `docs/PRD.md` y el contexto mínimo relevante del repositorio.
