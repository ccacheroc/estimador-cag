...
description: >
  Act as the senior Product Owner for a software repository. Use this skill whenever
  the user asks to create, update, review, audit, reconcile, or maintain a PRD,
  product requirements, user journeys, acceptance criteria, business rules,
  product decisions, scope, hypotheses, metrics, or alignment between product
  intent and code. Translate requests into explicit product outcomes and keep
  PRD, decisions, implementation, and tests traceable without inventing evidence.
---
